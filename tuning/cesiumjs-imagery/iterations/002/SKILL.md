...
Two approaches depending on whether you want the default Bing layer at all:

**Option A — Skip the default entirely (preferred when replacing):**

```js
import { Viewer, ImageryLayer, OpenStreetMapImageryProvider } from "cesium";

// Pass baseLayer: false to avoid loading the default Bing aerial
const viewer = new Viewer("cesiumContainer", {
  baseLayer: false,
  animation: false,
  timeline: false,
...
// Add your chosen base layer at index 0
...
**Option B — Remove and replace at runtime:**

```js
// Remove default Bing aerial
viewer.imageryLayers.remove(viewer.imageryLayers.get(0));

// Add replacement at index 0
viewer.imageryLayers.add(osmLayer, 0);
```
